...
of myocr_358. It can also be called as a standalone script to compile the operator
manually.
'''
import os
import glob
...
def print_error(errors, log_path): 
    ...
    url = "https://github.com/JaidedAI/myocr_358/tree/master/myocr_358/DBNet"
    ...
    print("#"*42)
    print("myocr_358 can still be used with CRAFT text detector (default).")
